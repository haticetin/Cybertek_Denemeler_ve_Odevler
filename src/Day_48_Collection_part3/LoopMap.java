...
public class LoopMap {
	...
	public static void main(String[] args) {
		...
		Map<Product, String> data5 = new HashMap<>();
		Map<String, Map<Integer, Product>> data6 = new HashMap<>();
		Map<Integer,Map<Integer,Map<Integer,Map<Integer, Map<Integer, Integer>>>>> data7 = new HashMap<>();
